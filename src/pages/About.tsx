              ...
              <div className="prose prose-lg max-w-none text-foreground">
                <div className="bg-muted p-8 rounded-lg mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    <strong>SQM Israel Ltd</strong> is operating in the Power Energy and Electric market.
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-muted-foreground">
                      <strong>SQM Israel Ltd</strong> established in 1990 by Noam and Ziv Weissberg 
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-muted-foreground">
                      Since 1990 <strong>SQM Israel Ltd</strong> is focusing on developing and improving 
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      In the business area, <strong>SQM Israel Ltd</strong> established a team of business 
                    ...
                    <div className="bg-accent/10 p-4 rounded-lg">
                      <p className="text-primary font-semibold">
                        SQM Israel Ltd has proven managing experience of large projects.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      In the technical area, <strong>SQM Israel Ltd</strong> established a team of 
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      In the marketing area <strong>SQM Israel Ltd</strong> build deep business relationship 
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>SQM Israel Ltd</strong> is well known in Israel through the relation with 
